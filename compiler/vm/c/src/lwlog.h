 ...
 * @date 2014/11/30
 *
 * lwlog is a simple logging library for C programs. We copied it from https://github.com/Akagi201/lwlog, and added a TRACE log level.
 */
...
#define lwlog_debug(M, ...)   do { fprintf(stderr, WHITE   "[DEBUG]   " "%s (%s:%d) " NONE M "\n", __func__, __FILE__, __LINE__, ##__VA_ARGS__); } while(0)
